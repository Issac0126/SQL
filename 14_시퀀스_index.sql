...
CREATE SEQUENCE dept3_seq
    ...
    MAXVALUE 10 --최대값 (기본값은 증가 1027, 감소일 때 -1) 감소일 땐 없어도ㄱㅊ...
    MINVALUE 1 --최소값 (기본값은 증가 1, 감소일 때 -1028) 증가일 땐 없어도 ㄱㅊ...
    NOCACHE --캐시메모리 사용 여부 (캐시를 사용할거면 CACHE)
...
ALTER SEQUENCE dept3_seq INCREMENT BY -2; --증가값 변경
